...
namespace LmycWeb.Controllers
{
    public class BoatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BoatId,BoatName,Picture,LengthInFeet,Make,Year,Record,CreationDate")] Boat boat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BoatId,BoatName,Picture,LengthInFeet,Make,Year,Record,CreationDate")] Boat boat)
        {
            if (id != boat.BoatId)
            {
                return NotFound();
